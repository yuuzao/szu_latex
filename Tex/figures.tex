...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.4\textwidth]{Img/XML}
...
\centering
\includegraphics[width=\textwidth]{Img/dataDimensions}
\caption{数据维数的变化}\label{fig:dd}
\end{minipage}
\begin{minipage}{0.4\textwidth}
\centering
\includegraphics[width=\textwidth]{Img/dataSize}
...
\begin{figure}[htbp]
  ...
  \subfigure[Data Dimensions]{\label{fig:subfig:datadim}
                \includegraphics[width=0.4\textwidth]{Img/dataDimensions}}
  \subfigure[Data Size]{\label{fig:subfig:datasize}
                \includegraphics[width=0.4\textwidth]{Img/dataSize}}
